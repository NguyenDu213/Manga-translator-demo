        ...
        optionList.forEach(option => {
            option.addEventListener('click', () => {
                ...
                if (selectBox.id === 'translator') {
                    ...
                    if (geminiSettings) {
                        geminiSettings.style.display = option.textContent === 'Gemini' ? 'block' : 'none';
                    }
                }
            });
        });
                ...
                optionList.forEach(opt => {
                    if (opt.textContent === savedValue) {
                        ...
                        if (selectBox.id === 'translator') {
                            const geminiSettings = document.getElementById('gemini-settings');
                            if (geminiSettings) {
                                geminiSettings.style.display = savedValue === 'Gemini' ? 'block' : 'none';
                            }
                        }
                    }
                });
...
function updateHiddenInputs() {
    ...
    document.getElementById("selected_ocr").value = "Manga-OCR";
    ...
    const editOcr = document.getElementById('edit_ocr_first');
    const form = document.querySelector('form');
    if (editOcr && editOcr.checked) {
        form.action = '/prepare-ocr';
    } else {
